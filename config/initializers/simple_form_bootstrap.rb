...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper :form_check_wrapper, tag: 'div', class: 'form-check' do |bb|
      ...
      bb.use :label, class: 'form-check-label w-100'
  ...
  config.wrappers :vertical_text_area, tag: 'div', class: 'mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :pattern
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.use :input, class: 'form-control', error_class: 'is-invalid', rows: 15
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
