...
class Admin::UsersController < ApplicationController
  ...
  def create
    ...
    flash[:notice] = t('activerecord.success.create', key: t('admin.users.title'))
  ...
  def update
    ...
    flash[:notice] = t('activerecord.success.update', key: t('admin.users.title'))
    respond_to do |format|
  ...
  def lock
    ...
    flash[:notice] = t('.message', user: @user.username)
    respond_to do |format|
      format.html { redirect_to edit_admin_user_path(@user) }
      format.turbo_stream
    end
